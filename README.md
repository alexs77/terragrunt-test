# Infrastructure code for "Tutti-QA.ap-south-1"
...
Infrastructure consists of multiple layers (autoscaling_12, autoscaling_11, autoscaling_10, ...) where each layer is configured using one of [Terraform AWS modules](https://github.com/terraform-aws-modules/) with arguments specified in `terraform.tfvars` in layer's directory.
...
Alternatively, you can create infrastructure in a single layer (eg, `autoscaling_12`):

    $ cd ap-south-1/autoscaling_12
    $ terragrunt apply
